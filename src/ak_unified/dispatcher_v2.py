...
def _dispatch_call(provider: ProviderSpec, dataset_id: str, params: Dict[str, Any]) -> Tuple[str, pd.DataFrame]:
    ...
    if adapter == 'akshare':
        ...
        fn_used, df = _sync_await(call_akshare([api_id], params, field_mapping=provider.field_mapping, allow_fallback=False, function_name=api_id))
        return fn_used, df
    ...
    if adapter == 'efinance':
        ...
        fn_used, df = call_efinance(dataset_id, params)
